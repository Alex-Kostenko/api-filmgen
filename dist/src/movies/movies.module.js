...
MoviesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([movie_entity_1.MovieEntity]), axios_1.HttpModule],
        controllers: [movies_controller_1.MoviesController],
        providers: [movies_service_1.default, movies_repository_1.MoviesRepository],
        exports: [movies_repository_1.MoviesRepository],
    })
], MoviesModule);
